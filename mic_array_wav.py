...
# package added to read a WAV fiel
import wave
...
'''
Si deseo abrir un archivo de audio, ejecutar los siguientes pasos:

1) Quitar de las lineas 31 a 47.

2) Cambiar el open de la linea 49 por el archivo wav
'''
...
class MicArray(object):
    ...
    def __init__(self, rate=16000, channels=8, chunk_size=None):
        ...
        wave_file = wave.open('/home/fernando/papa.wav','rb')
      ...
      #      format = self.pyaudio_instance.paInt16,
